            ...
            return assetCategoryApi.updateAssetCategory(categoryList, id).then(response => {
                ...
                if (response === undefined) {
                    notification["error"]({
                        message: `Thông báo`,
                        description:
                            'Chỉnh sửa danh mục xe thất bại',
                    });
                }
                else {
                    notification["success"]({
                        message: `Thông báo`,
                        description:
                            'Chỉnh sửa danh mục xe thành công',
                    });
                    handleCategoryList();
                ...
                <div>
                    <Row>
                        ...
                        <div
                            style={{ marginLeft: 10 }}>
                            <Popconfirm
                                title="Bạn có chắc chắn xóa danh mục xe này?"
                            ...
                            >
                                <Row>
                                    ...
                                    <Col span="6">
                                        <Row justify="end">
                                            <Space>
                                                <Button onClick={showModal} icon={<PlusOutlined />} style={{ marginLeft: 10 }} >Tạo danh mục xe</Button>
                                            </Space>
                                        </Row>
                                    </Col>
                                </Row>
