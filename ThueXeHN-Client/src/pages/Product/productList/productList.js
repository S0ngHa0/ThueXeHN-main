  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        await productApi.getProductsByCategory(id).then((item) => {
                ...
                <List
                  ...
                  renderItem={(item) => (
                    <List.Item>
                      ...
                      >
                        {item.image ? (
                          <img className="image-product-1" src={item.image} />
                        ) : (
                          <img
                        ...
                        <div className="wrapper-products">
                          ...
                          <div className="price-amount">
                            <Paragraph className="price-product">
                              {numberWithCommas(item?.rental_price)}đ 
                            </Paragraph>
                          </div>
                        </div>
                      </div>
