import {
  ...
  Input, List, Modal, Rate, Row, Select, Spin, Typography, message, notification, DatePicker
} from "antd";
...
const ProductDetail = () => {
  ...
  const paymentCard = (product) => {
    ...
    if (selectedDates.length === 2) {
      ...
      const days = moment(endDate).diff(moment(startDate), 'days');
       ...
       // Store startDate, endDate, and rentalDays in the cart
       console.log('Selected Start Date:', moment(startDate).format('DD/MM/YYYY'));
       console.log('Selected End Date:', moment(endDate).format('DD/MM/YYYY'));
  ...
  useEffect(() => {
    (async () => {
      try {
        await assetManagementApi.getDetailAssetManagement(id).then((item) => {
              ...
              <Col span={16}>
                ...
                >
                  <div className="price_product">
                    {Number(productDetail?.rental_price).toLocaleString("vi-VN", {
                      style: "currency",
                      currency: "VND",
                    })}/ngày
                  ...
                  <div class="box-product-promotion">
                    ...
                    <div class="box-content-promotion">
                      ...
                      <a>
                        Hỗ trợ tận tình - Tư vấn tận tâm<br />
                        <br /> Tặng thêm phiếu cho lần tiếp thep <br />
