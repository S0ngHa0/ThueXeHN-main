...
function Topbar() {
  ...
  return (
    ...
    >
      <div className="">
        <img style={{ color: "#000000", fontSize: 15, width: 200, cursor: "pointer" }} src={logo} onClick={() => handleLink("/home")}></img>
      </div>
      ...
      <div className={styles.navmenu} style={{ marginLeft: 20 }}>
        ...
        <a className={styles.navlink} href="http://localhost:3000/" target="_blank" rel="noopener noreferrer">
          Chở thành chủ xe
        </a>
